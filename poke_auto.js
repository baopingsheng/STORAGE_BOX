...
(function() {
    ...
    const scrollDuration = 1000; // Duration of smooth scroll in milliseconds
    ...
    function smoothScroll(targetY, duration) {
        ...
        function step(currentTime) {
            ...
            if (elapsedTime < duration) {
                ...
                if (time < 0.5) {
                    progress = 2 * time * time;
                } else {
                    progress = -1 + (4 - 2 * time) * time;
                }
    ...
    function scrollPage() {
        ...
        scrollCount++;
        console.log(`Smooth scrolling down (${scrollCount}/${maxScrolls})`);
    ...
    function startProcess() {
        ...
        console.log('Starting auto-click and smooth scroll process');
        ...
        setInterval(() => {
            if (isRunning) {
                status.textContent = isPaused ? 
                    'Status: PAUSED' : 
                    `Status: ${isScrolling ? 'SCROLLING' : 'RUNNING'} (${scrollCount}/${maxScrolls} scrolls)`;
            } else {
    ...
    window.addEventListener('load', () => {
        console.log('Auto-Click and Smooth Scroll userscript loaded');
        createControlPanel();
